            ...
            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('user')" :active="request()->routeIs('user')">
                                {{ __('Daftar Pengguna') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('registrasi')" :active="request()->routeIs('registrasi')">
                                {{ __('Registrasi Pengguna') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('koleksi')" :active="request()->routeIs('koleksi')">
                                {{ __('Daftar Koleksi') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('koleksiTambah')" :active="request()->routeIs('koleksiTambah')">
                                {{ __('Tambah Koleksi') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
