                                        ...
                                        <tr class="bg-white border-b">
                                            ...
                                            <td class="text-sm text-gray-900 font-light px-2 py-3 whitespace-nowrap">
                                                <div class="flex space-x-2 justify-center">
                                                    ...
                                                    <a href="{{route('koleksiDelete', $item->id)}}" type="button" class="inline-block px-6 py-2.5 bg-red-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">delete</a>
                                                </div>
                                            </td>
                                        </tr class="bg-white border-b">
                                        @endforeach
